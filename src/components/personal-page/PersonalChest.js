...
export default function NewListChest() {
  ...
  const listItems = exercises.map((exercise) =>
      ...
      <div>
        <Accordion square expanded={expanded === exercise.panel} onChange={handleChange(exercise.panel)} style={{border: 'none', backgroundColor: '#ffcc00!important', borderRadius: '10px', marginBottom: '10px'}}>
            ...
            <AccordionDetails>
                <Typography>
                    {exercise.users.slice(0, 1).map(function(user, index){
